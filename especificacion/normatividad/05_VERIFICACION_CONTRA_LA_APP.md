...
Contraste entre lo verificado en las fichas 01-04 y lo que la aplicación y `/especificacion/teoria` implementan hoy.
...
| La depreciación acumulada no supera la base depreciable | `especificacion/teoria/06` §169, y el motor la topa | ✅ |
| Valor residual no se deprecia | Configurable, 0 % por defecto | ✅ |
| El método debe ser una decisión documentada de la entidad | Acta obligatoria antes de calcular (`especificacion/teoria/06` §46, `VAL-01-07`) | ✅ |
