...
**Fecha:** 2026-09-01
**Fuente funcional autoritativa:** `/Teoria` (v2.0) y `/Plantillas_Valuacion_Activos`
...
Este directorio contiene el **plan técnico de construcción** de la aplicación descrita en `/Teoria`.
...
|:-:|---|---|
| 1 | `/Teoria/ANEXO_C_FORMULAS_Y_REGLAS.md` | Motor de cálculo. Prevalece sobre cualquier paso. |
| 2 | `/Teoria/*` (resto) | Requisitos funcionales, reglas de negocio, validaciones, entregables. |
| 3 | `/plan_desarrollo/*` | **Cómo** construirlo: arquitectura, stack, orden, verificación. |
| 4 | `/gestion_proyecto/*` | **Dónde vamos**: estado, progreso, bitácora. |

> Este plan **nunca** contradice a `/Teoria`. Las 15 discrepancias detectadas dentro de `/Teoria` se
...
> [`/Teoria/CORRECCIONES.md`](../Teoria/CORRECCIONES.md)— y el análisis se conserva en
...
| R-06 | Nada "quemado" en el código: todo dato variable entre hospitales es parámetro | `/Teoria/README.md` §4 |
| R-07 | Nunca borrar, siempre versionar; un ejercicio cerrado es inmutable | `/Teoria/00_MARCO_GENERAL.md` §10.5, `INT-09` |
| R-08 | Ningún ajuste sin soporte documental y sin responsable identificado | `/Teoria/00_MARCO_GENERAL.md` §5.6 |
...
1. `/gestion_proyecto/estado_actual.md` — **siempre primero**. Dice en qué punto está el desarrollo.
...
| `CT-<nn>` | Contradicción detectada en `/Teoria` | `CT-02` |
| `MOD-<nn>` | Módulo de la aplicación | `MOD-05` |
| `CV-<nn>` | Criterio de verificación | `CV-12` |

Los códigos de `/Teoria` (`RF-`, `RN-`, `VAL-`, `EN-`, `IN-`, `PL-`, `INT-`) se citan tal cual,
nunca se renumeran.
...
El estado vivo se lleva en `/gestion_proyecto/roadmap_progreso.md`. Esta tabla es solo el corte
