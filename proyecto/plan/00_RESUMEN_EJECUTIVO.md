...
## 5. Contradicciones de `/especificacion/teoria`: resueltas

El análisis detectó **15 discrepancias** dentro de `/especificacion/teoria`, cuatro de ellas bloqueantes. Todas se
...
[`/especificacion/teoria/CORRECCIONES.md`](../../especificacion/teoria/CORRECCIONES.md).
